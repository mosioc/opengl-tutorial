...
# بافت‌دهی در OpenGL - درس گرافیک کامپیوتری
...
### تمرین 1: بافت‌دهی پایه
1. یک مربع با بافت ساده رسم کنید
2. یک مکعب با بافت‌های مختلف در هر وجه رسم کنید
3. یک استوانه با بافت تکرار شونده رسم کنید
4. یک کره با بافت محیطی رسم کنید

### تمرین 2: بافت‌دهی پیشرفته
1. یک سطح با بافت نرمال رسم کنید
2. یک سطح با بافت جابجایی رسم کنید
3. یک شیء با بافت‌دهی چندگانه رسم کنید
4. یک شیء با بافت متحرک (انیمیشن بافت) رسم کنید

### تمرین 3: بافت‌دهی با شیدرها
1. یک شیدر ساده برای بافت‌دهی بنویسید
2. یک شیدر برای بافت‌دهی چندگانه بنویسید
3. یک شیدر برای بافت نرمال بنویسید
4. یک شیدر برای بافت جابجایی بنویسید

## مفاهیم پیشرفته

### 1. بافت‌های پروسیجرال
- تولید بافت با الگوریتم‌های ریاضی
- نویز پرلین و کاربرد آن در تولید بافت
- بافت‌های فرکتال

### 2. بهینه‌سازی بافت‌ها
- فشرده‌سازی بافت‌ها
- مدیریت حافظه برای بافت‌های بزرگ
- تکنیک‌های LOD برای بافت‌ها

### 3. بافت‌های پویا
- تغییر بافت در زمان اجرا
- انیمیشن بافت
- بافت‌های تعاملی
