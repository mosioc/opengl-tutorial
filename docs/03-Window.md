...
# مدیریت پنجره در OpenGL - درس گرافیک کامپیوتری
...
### تمرین 1: پنجره پایه
1. یک پنجره با اندازه 800x600 ایجاد کنید
2. عنوان پنجره را به "تمرین پنجره" تغییر دهید
3. با کلید ESC از برنامه خارج شوید

### تمرین 2: تعامل با پنجره
1. با کلیک راست ماوس یک منو نمایش دهید
2. با کلید F پنجره را تمام صفحه کنید
3. با تغییر اندازه پنجره، نسبت تصویر را حفظ کنید

### تمرین 3: چند پنجره
1. یک پنجره اصلی و یک پنجره فرعی ایجاد کنید
2. در پنجره فرعی یک شکل رسم کنید
3. با کلیک ماوس بین پنجره‌ها جابجا شوید
