...
## تمرینات
1. یک سیستم Frustum Culling پیاده‌سازی کنید و عملکرد آن را با و بدون این تکنیک مقایسه کنید
2. یک سیستم Occlusion Culling با استفاده از Occlusion Queries پیاده‌سازی کنید
3. یک سیستم LOD برای مدل‌های سه‌بعدی پیاده‌سازی کنید
4. یک سیستم مدیریت بافر و بافت بهینه پیاده‌سازی کنید
5. از ابزارهای پروفایل برای شناسایی گلوگاه‌های عملکرد در برنامه خود استفاده کنید
