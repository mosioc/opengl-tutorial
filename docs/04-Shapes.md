...
# رسم اشکال در OpenGL - درس گرافیک کامپیوتری
...
1. یک نقطه با اندازه 10 پیکسل در مرکز پنجره رسم کنید
2. یک خط مورب با رنگ‌های متغیر رسم کنید
3. یک مثلث با رنگ‌های مختلف در گوشه‌ها رسم کنید
4. یک مربع با رنگ‌های متغیر رسم کنید

### تمرین 2: رسم اشکال پیشرفته
1. یک دایره با 100 بخش رسم کنید
2. یک پنج‌ضلعی منظم رسم کنید
3. یک ستاره 5 پر رسم کنید
4. یک منحنی سهمی رسم کنید

### تمرین 3: تبدیلات هندسی
1. یک مربع رسم کنید و آن را 45 درجه بچرخانید
2. یک مثلث رسم کنید و آن را به اندازه 2 برابر بزرگ کنید
3. یک دایره رسم کنید و آن را به نقطه (0.5, 0.5) منتقل کنید
4. ترکیبی از تبدیلات را روی یک شکل اعمال کنید
...
### 2. بافت‌دهی (Texturing)
- بارگذاری بافت
- نگاشت بافت روی اشکال
